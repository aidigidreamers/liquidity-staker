...
import NetixswapV1ERC20 from '@aidigitaldreamers/v1-core/build/ERC20.json'
...
export async function stakingRewardsFixture([wallet]: Wallet[]): Promise<StakingRewardsFixture> {
  ...
  const stakingToken = await deployContract(wallet, NetixswapV1ERC20, [expandTo18Decimals(1000000)])
